...
library(stringr)
library(rvest)
politicians <- read.csv("C:\\Users\\shado\\Documents\\Abgeordnete_Kommunikation\\politicians_v1.csv", header = TRUE, stringsAsFactors = FALSE, sep = ";")
```
...
# export dataframe
write.csv(politicians, "C:\\Users\\shado\\Documents\\Abgeordnete_Kommunikation\\politicians_2.csv", row.names = FALSE)
```
